...
// *******************************************************
//	Facebook App ID
var facebookAppID	= '410152752526117'; //document.getElementById('facebook-login-button').getAttribute("appId");
// -------------------------------------------------------
//	Facebook User Data
var facebookUser = {};
//	Child objects:
...
var Facebook_correctLogin	= function () {
	...
	FB.api('/me', function(response) {
		...
		if (document.getElementById('fbStatus')){
			document.getElementById('fbStatus').innerHTML = '<i class="fa fa-facebook-official" aria-hidden="true"></i> ¡Bienvenido ' + facebookUser.name + '!'
		}
...
var Facebook_notConnected	= function () {
	if (document.getElementById('fbStatus')){
		document.getElementById('fbStatus').innerHTML = 'También puedes iniciar sesión con tu cuenta de Facebook.'
	}
};
...
var statusChangeCallback	= function (response) {
	...
	//	class.user no conectado a Facebook
